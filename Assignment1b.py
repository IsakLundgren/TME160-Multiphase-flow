...
for t in times:
    ...
    for bubbleID in aliveBubblesID: #loop over all alive bubbles at current time step ti
        ...
        #TODO: must be filled
        FtotY =      #total force on the bubble along y-direction
        totMass =      #total mass of the bubble + mass of the fluid carried by the bubble
        ...
        FtotX = #total force on the bubble along x-direction
